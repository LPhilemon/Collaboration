...
import com.example.makeitso.COURSES_SCREEN
...
class SplashViewModel @Inject constructor(
    ...
    fun onAppStart(openAndPopUp: (String, String) -> Unit) {
        if (accountService.hasUser()) openAndPopUp(COURSES_SCREEN, SPLASH_SCREEN)//COURSES_SCREEN STARTS
    ...
    private fun createAnonymousAccount(openAndPopUp: (String, String) -> Unit) {
        viewModelScope.launch(logErrorExceptionHandler) {
            accountService.createAnonymousAccount { error ->
                ...
                else openAndPopUp(COURSES_SCREEN, SPLASH_SCREEN)//changed to courses
            }
        }
    }
}